  ...
  return {
    ...
    link: function (scope, element, attrs) {
      ...
      function watch() {
        ...
        return scope.model ? new Date(scope.model).getMonth() : null;
      }
      ...
      scope.isSameMonth = function (date) {
        return isSameMonth(new Date(scope.model), date);
      };

      scope.isSameYear = function (date) {
        return isSameYear(new Date(scope.model), date);
      };

      scope.isSameDay = function (date) {
        return isSameDay(new Date(scope.model), date);
      };

      scope.isSameHour = function (date) {
        return isSameHour(new Date(scope.model), date);
      };

      scope.isSameMinutes = function (date) {
        return isSameMinutes(new Date(scope.model), date);
      };
