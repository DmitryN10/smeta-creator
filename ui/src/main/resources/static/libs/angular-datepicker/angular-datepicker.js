            ...
            return {
                ...
                'link': function linkingFunction($scope, element, attr) {
                    ...
                    var selector = attr.selector
                        ...
                        , theCalendar
                        , defaultPrevButton = '<b class="datepicker-default-button"><i class="glyphicon glyphicon-arrow-left"></i></b>'
                        , defaultNextButton = '<b class="datepicker-default-button"><i class="glyphicon glyphicon-arrow-right"></i></b>'
